...
<head>
    ...
    <title>GOBAR @ Parahyangan Golf - PAIRING TABLE</title>
    <!-- favicon -->
    ...
    <div class="container mt-3 mb-2">
        <div class="d-flex justify-content-center flex-column align-items-center">
            ...
            <h1 class="fw-light my-5 text-center" style="color: #000">
                GOBAR @ PARAHYANGAN GOLF<br /><span class="fw-semibold">Standings Table</span>
            </h1>
            <h1 class="fw-light my-5 text-center" style="color: #000">
                <span class="fw-semibold">We will back soon</span>
            </h1>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card border-dark shadow">
                    <div class="card-header bg-dark bg-gradient fw-bold text-center text-white">
                        <h5 style="font-weight: 600;" class="text-center">List Pairing 14 December 2023</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table class="table-bordered mb-2 table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>3</td>
                                                <td>Rudolf Tulus P. Sirait
                                                </td>
                                                <td>Male</td>
                                            </tr>
                                            <tr>
                                                <td>4</td>
                                                <td>Michael Kurnia Wirawan Alifen
                                                </td>
                                                <td>Male</td>
                                            </tr>
                                        </tbody>
