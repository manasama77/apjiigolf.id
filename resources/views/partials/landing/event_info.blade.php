<section class="page-section bg-secondary" id="event_info">
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-12 text-center">
                <h2 class="text-white text-center mt-0">Event Information</h2>
                ...
                <a class="btn btn-light btn-xl mt-3 shadow" href="#ticket_pricing">See Price Info</a>
            </div>
        </div>
    </div>
</section>
