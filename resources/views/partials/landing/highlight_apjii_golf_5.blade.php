    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-12 text-center">
                <h2 class="text-center mt-0">APJII GOLF 5</h2>
                <hr class="divider divider-light" />
                <div class="row">
                    <div class="col-sm-12">
                        <div class="gallery">
                            @for ($i = 1; $i <= 12; $i++)
                                <a href="{{ asset('events/APJII Golf 5 (2022)/APJIIGOLF5 (' . $i . ').JPG') }}"
                                    data-lightbox="gobar-1">
                                    <img src="{{ asset('events/APJII Golf 5 (2022)/APJIIGOLF5 (' . $i . ').JPG') }}"
