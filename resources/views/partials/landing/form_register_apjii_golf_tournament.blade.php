                            ...
                            <div class="card">
                                <div class="card-body bg-warning">
                                    <div class="text-center">
                                        <h4 class="card-title fw-bold">Registration Closed</h4>
                                    </div>
                                </div>
                            ...
                            <form id="form" action="{{ route('register_store') }}" method="post">
                                ...
                                <div class="card bg-light">
                                    <div class="card-body bg-white">
                                        ...
                                        <hr class="divider" />
                                        <p class="text-muted mb-5">Experience the excitement of golf with PGA friends.
                                        </p>
                                        @if ($errors->any())
                                            ...
                                            <div class="col-sm-12 col-md-4">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select" id="position" name="position"
                                                        ...
                                                        <option @selected(old('position') == 'Staff - Supervisor')
                                            ...
                                            <div class="col-sm-12 col-md-4">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select" id="institution" name="institution"
                                                        required>
                                                        <option value=""></option>
                                                        <option @selected(old('institution') == 'APJII Member (ISP)')
                                                            value="APJII Member (ISP)">
                                                            APJII Member (ISP)
                                                        </option>
                                                        <option @selected(old('institution') == 'Regulator') value="Regulator">
                                                            Regulator
                                                        </option>
                                                        <option @selected(old('institution') == 'Operator Data Center')
                                                            value="Operator Data Center">
                                        ...
                                        <div class="row mb-3 justify-content-center">
                                            ...
                                            <div
                                                ...
                                                <input type="radio" class="btn-check" name="shirt_size"
                                    ...
                                    <div class="card-footer mb-3">
                                        ...
                                        @if ($registration_status == true)
                                            <button id="btn_submit" type="submit"
                                                class="btn btn-primary w-100 mt-3 shadow"
                                                style="letter-spacing: 2px;">
                                        ...
                                        <a class="btn btn-info w-100 mt-3 shadow"
                                            href="{{ route('register_check') }}" style="letter-spacing: 2px;">
                                            <i class="fas fa-table fa-fw"></i> Check Payment
                                        </a>
                                    </div>
                                </div>
