                ...
                <div class="col-lg-12 text-center">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="gallery">
                                @for ($i = 1; $i <= 100; $i++)
                                    <a href="{{ asset('events/GOBAR 3 (Parahyangan Golf)/1/GOBAR_AT_PARAHYANGAN_GOLF (' . $i . ').JPG') }}"
                                        data-lightbox="gobar-1">
                                        <img src="{{ asset('events/GOBAR 3 (Parahyangan Golf)/1/thumb/GOBAR_AT_PARAHYANGAN_GOLF (' . $i . ').JPG') }}"
