...
<head>
    ...
    <title>PAIRING TABLE - GOBAR 5 AT PERMATA SENTUL GOLF CLUB</title>
    <!-- favicon -->
    ...
    <div class="container mt-3 mb-2">
        <div class="d-flex justify-content-center flex-column align-items-center">
            ...
            <h1 class="fw-light my-5 text-center" style="color: #000">
                <span class="fw-semibold">Pairing Table</span><br /><small>GOBAR 5<BR />PERMATA SENTUL GOLF CLUB</small>
            </h1>
        </div>
                                ...
                                <div class="table-responsive mt-3 mt-md-0">
                                    <table class="table-bordered mb-2 table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>3</td>
                                                <td>JANUAR KRISDWIPUTRA
                                                </td>
                                                {{-- <td>Male</td> --}}
                                            </tr>
                                            <tr>
                                                <td>4</td>
                                                <td>HERY KURNIAWAN</td>
                                                {{-- <td>Male</td> --}}
                                            </tr>
                                        </tbody>
                                    </table>
        ...
        <footer class="d-flex justify-content-center border-top my-4 flex-wrap pt-3">
            <div class="col-8 d-flex align-items-center">
                ...
                <span class="mb-md-0 mb-3 text-white fw-bold">
                    © Copyright <?php echo date('Y'); ?>. Persatuan Golf APJII.
                </span>
                </span>
            </div>
