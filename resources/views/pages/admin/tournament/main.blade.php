                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="{{ route('register_download_eticket', $r->invoice_number) }}" class="dropdown-item">
        ...
        new DataTable('#tables', {
            ...
            , buttons: [
                'copy', 'csv', {
                    ...
                    , title: 'Registrations APJII Golf Tournament 7 - ' + new Date().getFullYear() + new Date().getMonth() + new Date().getDate()
                    , exportOptions: {
