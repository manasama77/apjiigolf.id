        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-danger">
                    ...
                    <a href="{{ route('admin.master_location') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-warning">
                    ...
                    <a href="{{ route('admin.event_location') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-info">
                    ...
                    <a href="{{ route('admin.player_management') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
