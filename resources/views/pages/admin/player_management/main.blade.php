...
@section('aku_isi_mas')
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('admin.player_management.create') }}" class="btn btn-primary mb-3">
                                ...
                                @foreach ($lists as $l)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.player_management.edit', $l->id) }}"
                                                class="btn btn-info">
                                            ...
                                            <form id="form_delete_{{ $l->id }}"
                                                action="{{ route('admin.player_management.destroy', $l->id) }}"
