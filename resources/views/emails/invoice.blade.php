                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                style="margin: 0px; color: #242424; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 27px; font-weight: 700;">
                                                                {{ $location_name }}<br />Payment
                                                                Information </h1>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-font-size"
                                                                ...
                                                                <div class="alert alert-warning"
                                                                    ...
                                                                    After making the transfer, please wait a maximum of
                                                                    <b>5 minutes</b> for the system to process the
                                                                    payment & send the E-Ticket. Don't forget to check
                                                                    the spam folder in your email.
                                                                </div>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_text_3"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:20px 10px 20px 30px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">
