                ...
                <div class="col-lg-12 text-center">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="gallery">
                                @for ($i = 1; $i <= 100; $i++)
                                    <a href="{{ asset('events/GOBAR 3 (Parahyangan Golf)/4/GOBAR_AT_PARAHYANGAN_GOLF (' . $i . ').JPG') }}"
                                        data-lightbox="gobar-1">
                                        <img src="{{ asset('events/GOBAR 3 (Parahyangan Golf)/4/thumb/GOBAR_AT_PARAHYANGAN_GOLF (' . $i . ').JPG') }}"
                    ...
                    <div class="row">
                        <div class="col-12 mt-5 d-flex justify-content-center">
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                    <li class="page-item">
                                        <a class="page-link" href="{{ route('gobar_3_3') }}" aria-label="Previous">
                                    ...
                                    <li class="page-item">
                                        <a class="page-link" href="{{ route('gobar_3_5') }}" aria-label="Next">
