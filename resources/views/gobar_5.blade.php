                        ...
                        <div class="col-sm-12">
                            <div class="gallery">
                                @foreach ($images as $image)
                                    <a href="{{ asset('events/' . $image) }}" data-lightbox="gobar-5">
                                        <img src="{{ asset('events/' . $thumbs[$loop->iteration - 1]) }}" alt=""
                                            title="" class="img-thumbnail" loading="lazy" />
                                    </a>
                                @endforeach
                                {{-- <a href="{{ asset('events/gobar-pga-series-bogor-raya-2024-06-15/GOBAR PGA SERIES 1 (' . $i . ').JPG') }}"
                                        data-lightbox="gobar-1">
                                        <img src="{{ asset('events/gobar-pga-series-bogor-raya-2024-06-15/thumb/GOBAR PGA SERIES 1 (' . $i . ').JPG') }}"
