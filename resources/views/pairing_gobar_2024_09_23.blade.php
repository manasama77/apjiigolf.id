...
<head>
    ...
    <title>PAIRING TABLE - GOBAR 7 AT BUKIT DARMO GOLF SURABAYA</title>
    <!-- favicon -->
    ...
    <div class="container mt-3 mb-2">
        <div class="d-flex justify-content-center flex-column align-items-center">
            ...
            <h1 class="fw-light my-5 text-center" style="color: #000">
                <span class="fw-semibold">Pairing Table</span><br /><small>GOBAR 7<BR />BUKIT DARMO GOLF
                    SURABAYA</small>
            </h1>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card border-dark shadow">
                    <div class="card-header bg-dark bg-gradient fw-bold text-center text-white">
                        <h5 style="font-weight: 600;" class="text-center">List Pairing 23 September 2024</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
